...
Now we consider with population dynamics
...
for(i in 1:length(surv_prob_seq)) {
  ...
  i_survival <- surv_prob_seq[i]
  sim <- smile_fx(tau = 10, theta = 100, b_fixed = 0.001, years = 20, age_struc = TRUE, N1 = 20000, K =15000, rho_pop = 0.36,
...
In this case, we see that we have oscillations due to the yearly birth pulses, and essentially the susceptible pool comes from those new individuals joining the population. Because we have a relatively high survival probability, the immune compartment hovers over the carrying capacity, in this case, 15000. 
