...
png("research_day_figs/novax_scenarios_SL_seasonfacet.png", width = 13 , height = 8, units = "in", res = 300, type = "windows")
bind_rows(long_novax_noseason, long_novax_yesseason) %>% 
  filter(compartment %in% c("S", "L")) %>%
  ggplot(aes(x = week, y = n, color = compartment)) +
  facet_wrap(~seasonality, scales = "free") +
  geom_line(linewidth = 0.8) +
  theme_bw() +
  scale_color_manual(values = c("#E95562FF", "#120D32FF")) +
  # scale_linetype_manual(values = c("dashed", "solid")) +
...
case_data %>% 
  ...
  geom_path(aes(color = species, group = species, linetype = species), size = 1.2, alpha = 0.8) +
  theme_bw() +
...
ggsave("research_day_figs/noseason_low_surv_det.png")
...
ggsave("research_day_figs/noseason_med_surv_det.png")
...
ggsave("research_day_figs/noseason_high_surv_det.png")
...
ggsave("research_day_figs/season_low_surv_det.png")
...
ggsave("research_day_figs/season_med_surv_det.png")
...
ggsave("research_day_figs/season_high_surv_det.png")
...
vax_season_med_surv %>% 
  mutate(seasonality = "no", survival = "low") %>% 
