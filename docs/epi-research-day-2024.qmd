...
vax_season_low_survival <- smile_fx(theta = 10, tau = 10, years = 23,
                            # Parameters to induce seasonal forcing in transmission
                            b0 = -30, b1 = 0.85, period = 3*52,
                            # parameters for survival curve with varying vaccination levels
                            beta_0 = -10, beta_1 = 10, vax = vacc.pcts,
...
vax_season_med_survival <- smile_fx(theta = 10, tau = 10, years = 23,
                            # Parameters to induce seasonal forcing in transmission
                            b0 = -30, b1 = 0.85, period = 3*52,
                            # parameters for survival curve with varying vaccination levels
                            beta_0 = -3, beta_1 = 10, vax = vacc.pcts,
...
vax_season_high_survival <- smile_fx(theta = 10, tau = 10, years = 23,
                            # Parameters to induce seasonal forcing in transmission
                            b0 = -30, b1 = 0.85, period = 3*52,
                            # parameters for survival curve with varying vaccination levels
                            beta_0 = 1.5, beta_1 = 10, vax = vacc.pcts,
...
bind_rows(vax_noseason_low_survival %>% make_smile_long() %>% mutate(seasonality = "no", survival = "low"),
          vax_noseason_med_survival %>% make_smile_long() %>% mutate(seasonality = "no", survival = "med"))
