...
Then, the seasonality of the outbreaks is not clear from the data, maybe some cases every 3-5 years, but none when vaccination was high, the again every 3ish years. The red line shows what we assume is the number of infections caused by 1 LIZ when $\frac{\tau}{\theta} = 0$ and there is no seasonality.
