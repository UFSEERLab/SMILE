...
The code below shows the original script with the defined functions to evaluate the model under different assumptions of population dynamics or seasonal forcing. This is code show in the [first commit for this repository](https://github.com/UFSEERLab/SMILE/tree/e176302c90e16205b0211906e1ef93e641776407). 
```{r OG_fxs}
# OG functions 
